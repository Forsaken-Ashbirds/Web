...
<header>
	...
	<nav>
		...
		<ul>
			...
			<li aria-current={$page.url.pathname === '/community' ? 'page' : undefined}>
...
<style lang="scss">
	...
	nav a {
		...
		border-radius: 999px;
		transition: color 0.2s linear, background 0.2s ease, transform 0.2s ease;
	}
